...
SeaBombs.StartMenu.prototype = { 
	...
	create: function () {
		...
		this.instr = 'Use your mouse or space to fire, arrows to move target up and down     Press P to pause and unpause.';
		this.instructions = this.add.bitmapText(this.world.centerX-630, this.world.centerY+50, 'eightbitwonder', this.instr, 14);
